...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between rounded-md border-[2px] border-richblack-5 bg-[#6332f6]  p-8 px-12">
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[2px] border-richblack-5 bg-[#6332f6]  p-8 px-12">
